...
const HOME_MARKER = "data-rootward-doc-home";
...
.rootward-doc-home a:hover {
  color: #0f766e;
  text-decoration: underline;
}
.rootward-doc-home span {
  color: #64748b;
  display: block;
  font-size: .78rem;
  font-weight: 400;
...
<div class="rootward-doc-home" ${HOME_MARKER}>
  <a href="${escapedHref}">← Rootward 文档首页<span>Rootward 契约书库</span></a>
</div>`;
